...
class EmailSender:
    ...
    @staticmethod
    def _message_sender(message: str, receiver_email: str) -> NoReturn:
    ...
    @classmethod
    def send_html_email_message(cls, plain_html_message: str, receiver_email: str) -> NoReturn:
        ...
        EmailSender._message_sender(message=message.as_string(), receiver_email=receiver_email)

    @classmethod
    def send_plain_text_email_message(cls, plain_text_message: str, receiver_email: str):
        EmailSender._message_sender(message=plain_text_message, receiver_email=receiver_email)
